...
@router.post("/profile", response_model=ProfileResponse, tags=["settings"], summary="Get nurse profile information")
...
@router.put("/change-password", tags=["settings"], summary="Change nurse password")
async def change_password(request: ChangePasswordRequest):
    user_id = decode_token_get_nurse(request.token)
    conn, cur = None, None
...
@router.put("/update-profile", response_model=ProfileResponse, tags=["settings"], summary="Update nurse profile")
...
@router.delete("/delete-account", tags=["settings"], summary="Delete nurse account")
